...
import { Bot, Sparkles, MessageCircle, BookOpen, Zap, ArrowLeft, Clock, Target, CheckCircle2 } from 'lucide-react';
...
import { courseInfo, chatbotIntro, tracks, modules } from '../lib/course-data';
...
const features = [
  {
    ...
    description: 'هر سوالی درباره محتوای دوره دارید بپرسید',
  },
  {
    icon: BookOpen,
    title: 'راهنمای یادگیری',
    description: 'مسیر یادگیری مناسب شما را پیدا کنید',
  },
  {
    icon: Zap,
    title: 'توضیح مفاهیم',
    description: 'مفاهیم پیچیده را ساده بفهمید',
  },
];
          ...
          >
            ...
            <motion.div variants={itemVariants} className="text-center mb-6 sm:mb-8 px-2">
              <h1 className="text-3xl sm:text-5xl lg:text-7xl font-black text-dark-700 mb-4 sm:mb-6 leading-tight">
                <span className="golden-highlight">مشاور</span> دوره
                <br />
                {courseInfo.name}
              </h1>
            ...
            <motion.div 
              variants={itemVariants}
              className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 px-2 sm:px-0"
            >
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4 sm:flex sm:flex-wrap sm:justify-center sm:gap-16 max-w-md sm:max-w-none mx-auto">
              <div className="text-center">
                <div className="text-3xl sm:text-5xl font-black text-primary mb-1 sm:mb-2">۴</div>
                <div className="text-dark-300 text-xs sm:text-base">مسیر یادگیری</div>
              </div>
              <div className="text-center">
                <div className="text-3xl sm:text-5xl font-black text-primary mb-1 sm:mb-2">۵</div>
                <div className="text-dark-300 text-xs sm:text-base">ماژول اصلی</div>
              </div>
              <div className="text-center">
                <div className="text-3xl sm:text-5xl font-black text-primary mb-1 sm:mb-2">+۳</div>
                <div className="text-dark-300 text-xs sm:text-base">ساعت محتوا</div>
              </div>
            </div>
          </motion.div>
        </Container>
      ...
      <section id="course-content" className="py-10 sm:py-16 bg-white border-b border-dark-100">
        <Container>
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 sm:gap-8">
            <div className="lg:max-w-2xl text-center sm:text-right">
              <motion.h2
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                <span className="golden-highlight">محتوای</span> دوره
              </motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-1.5 sm:gap-3 bg-dark-50 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl">
                ...
                <span className="font-semibold text-xs sm:text-base">۴ مسیر</span>
              </div>
              <div className="flex flex-col sm:flex-row items-center gap-1.5 sm:gap-3 bg-dark-50 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl">
                <Target className="w-4 h-4 sm:w-5 sm:h-5 text-primary-600" />
                <span className="font-semibold text-xs sm:text-base">۵ ماژول</span>
              </div>
            </motion.div>
          </div>
        </Container>
        ...
        <Container>
          <div className={`grid gap-8 sm:gap-12 ${isDesktop ? 'grid-cols-12' : ''}`}>
            ...
            <motion.div
              ...
              className={isDesktop ? 'col-span-4' : 'text-center sm:text-right'}
            >
              <div className="sticky top-24">
                ...
                <p className="text-dark-400 leading-relaxed mb-6 sm:mb-8 text-sm sm:text-base">
                  در بیش از {courseInfo.duration} محتوای آموزشی، یاد می‌گیرید چطور هوش مصنوعی را در کارتان به کار ببرید. جلسات مستقیم، متمرکز و عملی هستند.
                </p>
                ...
                <div className="p-4 sm:p-6 bg-dark-700 rounded-xl sm:rounded-2xl text-white relative overflow-hidden">
                  ...
                  <h4 className="font-bold text-base sm:text-lg mb-1.5 sm:mb-2 relative z-10 text-right">سوالی دارید؟</h4>
                  <p className="text-dark-200 text-xs sm:text-sm mb-3 sm:mb-4 relative z-10 text-right">
                    مشاور دوره آماده پاسخگویی به سوالات شماست
                  </p>
                  <Button
                    size={isMobile ? 'md' : 'lg'}
                    onClick={startChat}
                    ...
                    {tracks.map((track) => (
                      <AccordionItem key={track.id} id={track.id}>
                        ...
                        <AccordionContent id={track.id} className="px-4 sm:px-6">
                          <p className="mb-3 sm:mb-4 text-sm sm:text-base text-right">{track.description}</p>
                            ...
                            <div className="flex flex-wrap gap-1.5 sm:gap-2">
                              ...
                              {module.topics.length > (isMobile ? 3 : 4) && (
                                <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-primary/10 text-primary-700 text-[10px] sm:text-xs rounded-full">
                                  +{module.topics.length - (isMobile ? 3 : 4)} موضوع دیگر
                                </span>
                              )}
                            </div>
                          </div>
